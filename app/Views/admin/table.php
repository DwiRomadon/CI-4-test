...
<div class="page-header">
    <h1 class="page-title">Table 01</h1>
    <div>
        <ol class="breadcrumb">
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p>Use <code class="highlighter-rouge">.table-bordered</code>to add zebra-striping to any table row
                    within the <code class="highlighter-rouge">.tbody</code>.</p>
                <div class="table-responsive">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p>Use <code class="highlighter-rouge">.table-hover</code>to add zebra-striping to any table row within
...
<div class="row">
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p>Use <code class="highlighter-rouge">.table-borderless</code>to add zebra-striping to any table row
                    within the <code class="highlighter-rouge">.tbody</code>.</p>
                <div class="table-responsive">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p>Add <code class="highlighter-rouge">.table-sm</code> to make any <code
                        class="highlighter-rouge">.table</code> more compact by cutting all cell <code
                        class="highlighter-rouge">padding</code> in half.</p>
                <div class="table-responsive">
...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card">
            ...
            <div class="card-body">
                <p>Use <code class="highlighter-rouge">.table-dark</code>to add zebra-striping to any table row within
                    the <code class="highlighter-rouge">.tbody</code>.</p>
                <div class="table-responsive">
